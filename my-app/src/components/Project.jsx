    ...
    return (
        <div className=' w-full flex justify-center bg-gray-50' id='project'>
            <div className='w-11/12 px-5 py-10 lg:w-225 flex flex-col gap-10'>
                <h1 className='text-3xl font-semibold md:text-4xl text-center'>Project <FontAwesomeIcon icon={faCube} className='text-yellow-600 ' /></h1>
                <div className='grid grid-cols-1  gap-8 md:grid-cols-2'>
                    ...
                    <div className='flex flex-col gap-4 '>
                        <h4 className='text-2xl font-semibold text-yellow-600 '>Social media app
                        </h4>
